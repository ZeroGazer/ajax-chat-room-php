...
move_uploaded_file($_FILES['userfile']['tmp_name'], $_POST["name"] . "." . pathinfo($_FILES['userfile']['name'], PATHINFO_EXTENSION));

// add the user picture location
$xmlh->setAttribute($user_element, "picture", $_POST["name"] . "." . pathinfo($_FILES['userfile']['name'], PATHINFO_EXTENSION));
